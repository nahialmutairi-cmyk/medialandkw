...
function getSeoForPathnameRaw(pathname: string): PageSEO {
  ...
  const defaults: PageSEO = {
    ...
    description: 'ميديا لاند شركة دعاية وإعلان في الكويت تقدم تصميم الإعلانات، الهوية البصرية، إنتاج الفيديو، تصميم المواقع، وإدارة الحملات الرقمية للشركات.',
    h1: 'شركة دعاية وإعلان في الكويت',
  ...
  if (path === '/services') {
    return {
      pathname: '/services',
      title: 'خدمات الدعاية والإعلان في الكويت | ميديا لاند',
