...
function PrivacyContent() {
  return <>
    ...
    <Section title="2. How we use information">We use information to provide advertising services, authenticate authorized users, assign reports to the correct client organization, produce reporting, maintain security, respond to support requests, and comply with legal obligations. Where a client portal includes campaign controls, authorized users may request campaign enable or pause actions for the single campaign assigned to their secure portal token. The portal never exposes credentials or financial data in the browser.</Section>
...
function TermsContent() {
  return <>
    ...
    <p>These Terms govern Media Land advertising services and its secure Google Ads client portal. By using the Services, you agree to these Terms and applicable law.</p>
    <Section title="1. Campaign reporting and controls">The portal retrieves reporting information through authorized Google Ads integrations. If campaign controls are enabled for an assigned client, the portal may submit server-side enable or pause requests only for the campaign bound to that client’s secure token. It does not expose campaign identifiers, credentials, budgets, bids, billing, invoices, or payment information to the browser.</Section>
