import { ExternalLink, Instagram, MapPin, MessageCircle, Music2, Phone, Scale, Twitter } from 'lucide-react';

const clientPath = '/clients/lawyer-yousef-alabdali/';
const phoneVisible = '98875444';
const phoneHref = 'tel:+96598875444';
const whatsappHref = 'https://wa.me/96598875444';
const mapsHref = 'https://maps.google.com/maps?q=%D9%85%D9%83%D8%AA%D8%A8%2B%D8%A7%D9%84%D8%B9%D8%A8%D8%AF%D9%84%D9%8A%2B%D9%84%D9%84%D9%85%D8%AD%D8%A7%D9%85%D8%A7%D8%A9%2B%D8%A7%D9%84%D8%A3%D8%AD%D9%85%D8%AF%D9%89%2C%2BKW&sll=29.18022403,48.119598';
const instagramHref = 'https://instagram.com/lawyeryousef';
const twitterHref = 'https://x.com/lawyeryousef';
const tiktokHref = 'https://www.tiktok.com/@lawyeralabdli';
...
const bio = 'المحامي يوسف العبدلي، ألتزم بتقديم استشارات قانونية دقيقة لحماية مصالحك وضمان حقوقك بكل أمانة ومهنية. خبرتي القانونية في خدمتك لتقديم حلول فعالة وواضحة تمنحك الثقة في كل خطواتك القانونية.';

function trackYousef(eventName: string, ctaLocation: string) {
...
function contactLinks() {
  return [
    ...
    { label: 'الموقع الجغرافي على الخرائط', href: mapsHref, icon: MapPin, event: 'maps_click' },
    { label: 'Instagram', href: instagramHref, icon: Instagram, event: 'instagram_click' },
    { label: 'Twitter / X', href: twitterHref, icon: Twitter, event: 'twitter_click' },
    { label: 'TikTok', href: tiktokHref, icon: Music2, event: 'tiktok_click' },
  ];
}

export function ClientLawyerYousef() {
  return (
        ...
        <section className="overflow-hidden rounded-[32px] border border-zinc-800 bg-[#1a1a1a]/60 shadow-2xl backdrop-blur-md">
          ...
          <div className="-mt-14 px-6 pb-7">
            <div className="relative flex flex-col items-center text-center">
              <img
                src="/clients/yousef-avatar.jpg"
                alt="المحامي يوسف العبدلي"
                className="h-28 w-28 rounded-full border-4 border-[#111111] object-cover shadow-xl"
              />
              ...
              <h1 className="mt-4 text-3xl font-black leading-tight text-white">المحامي يوسف العبدلي</h1>
              ...
              {contactLinks().map((item) => {
                ...
                return (
                  <a
                    ...
                    onClick={() => trackYousef(`lawyer-yousef-alabdali_${item.event}`, item.label)}
