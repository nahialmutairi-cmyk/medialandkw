    ...
    <div id="contact" className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-20">
      ...
      <div className="lg:col-span-5 space-y-6">
        ...
        <p className="text-gray-300/80 leading-relaxed text-justify text-sm">
          تواصل مع فريق ميديا لاند الإعلامي الآن لوضع دراسة تسويقية مخصصة لمشروعك تناسب ميزانيتك، وتضمن ريادتك في السوق الكويتي. نرد ونحدد موعداً للاستشارة والتحليل الرقمي خلال ساعات قليلة.
        </p>
